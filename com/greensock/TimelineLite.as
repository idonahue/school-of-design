...
class com.greensock.TimelineLite extends SimpleTimeline {
		...
		public function goto(timeOrLabel:Object, suppressEvents:Boolean):Void {
			if (typeof(timeOrLabel) == "string") {
				if (_labels[timeOrLabel] != undefined) {
					setTotalTime((this.cachedReversed) ? this.duration - Number(_labels[timeOrLabel]) : Number(_labels[timeOrLabel]), Boolean(suppressEvents != false));
				}
			} else {
